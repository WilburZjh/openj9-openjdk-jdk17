    ...
    public long importKey(long hSession, CK_ATTRIBUTE[] attributes) throws PKCS11Exception {
        ...
        if (keyClass == CKO_PRIVATE_KEY) {
            if (keyType == CKK_RSA) {
                ...
                if (ckaECParams == null) {
                    throw new PKCS11Exception(CKR_GENERAL_ERROR, "CKA_EC_PARAMS attribute is missing");
                }
                try {
            ...
            if (ckaValue == null) {
                throw new PKCS11Exception(CKR_GENERAL_ERROR, "CKA_VALUE attribute is missing");
            }
